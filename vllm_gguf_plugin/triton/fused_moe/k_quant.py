...
def ggml_moe_q3_k_triton(
    ...
    return run_triton_fused_moe_kernel(
        q3_k_moe_kernel, W, X, sorted_token_ids, expert_ids, num_tokens_post_padded, row, top_k, tokens, GGML_TYPE_Q3_K
    )
...
def ggml_moe_q5_k_triton(
    ...
    return run_triton_fused_moe_kernel(
        q5_k_moe_kernel, W, X, sorted_token_ids, expert_ids, num_tokens_post_padded, row, top_k, tokens, GGML_TYPE_Q5_K
    )
...
def ggml_moe_q6_k_triton(
    ...
    return run_triton_fused_moe_kernel(
        q6_k_moe_kernel, W, X, sorted_token_ids, expert_ids, num_tokens_post_padded, row, top_k, tokens, GGML_TYPE_Q6_K
    )
