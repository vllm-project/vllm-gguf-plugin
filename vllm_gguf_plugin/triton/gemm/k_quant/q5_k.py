...
def ggml_gemm_q5_k_triton(W: torch.Tensor, X: torch.Tensor, row: int) -> torch.Tensor:
    return run_triton_kernel(q5_k_gemm_kernel, W, X, row, GGML_TYPE_Q5_K)
