...
def ggml_gemm_q5_0_triton(W: torch.Tensor, X: torch.Tensor, row: int) -> torch.Tensor:
    return run_triton_kernel(q5_0_gemm_kernel, W, X, row, GGML_TYPE_Q5_0)
