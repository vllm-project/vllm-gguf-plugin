...
Tensor ggml_mul_mat_a8_q4_0_mmq_v2(Tensor W, Tensor X, int64_t row);
Tensor ggml_mul_mat_a8_iq4_xs_mmq_v2(Tensor W, Tensor X, int64_t row);
...
Tensor ggml_moe_a8_iq4_xs_mmq_v2(Tensor X, Tensor W, Tensor sorted_token_ids,
                                 Tensor expert_ids,
                                 Tensor num_tokens_post_padded, int64_t row,
...
STABLE_TORCH_LIBRARY_IMPL(_C_gguf, CUDA, ops) {
  ...
  ops.impl("ggml_moe_a8_iq4_xs_mmq_v2",
           TORCH_BOX(&ggml_moe_a8_iq4_xs_mmq_v2));
}
